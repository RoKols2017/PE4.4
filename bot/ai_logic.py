...
CONTACT_LABEL = "phone or Telegram username"
    ...
    def respond(
        ...
        *,
        ...
        try:
            ...
            LOGGER.debug(
                "[bot.ai_logic] Sending structured prompt",
                extra={
                    "step": current_step,
            ...
            LOGGER.info(
                "[bot.ai_logic] Structured response parsed",
                extra={
                    "step": current_step,
                    "chat_id": correlation_id,
            ...
            LOGGER.error(
                "[bot.ai_logic] Structured model call failed: %s",
                error,
                extra={"step": current_step, "chat_id": correlation_id},
            )
        ...
        if resolved.used_fallback:
            LOGGER.warning(
                "[bot.ai_logic] Deterministic fallback activated",
                extra={
                    "step": current_step,
                    "chat_id": correlation_id,
            ...
            LOGGER.debug(
                "[bot.ai_logic] Structured policy resolved",
                extra={
                    "step": current_step,
                    "chat_id": correlation_id,
