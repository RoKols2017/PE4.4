...
const STEP_ORDER: DialogStep[] = ["name", "contact", "request", "confirm"]

export class ConversationHandler {
  constructor(private readonly options: ConversationHandlerOptions) {}
  ...
  private buildConfirmation(session: ConversationSession): string {
  ...
  private promptFor(step: DialogStep): string {
    if (step === "name") {
  ...
  private bumpStep(session: ConversationSession, next: DialogStep): void {
