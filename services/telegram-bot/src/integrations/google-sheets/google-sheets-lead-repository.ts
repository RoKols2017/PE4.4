...
import type { PersistedLead, LeadRepository } from "../../application/ports/lead-repository.js"
import type { Lead } from "../../../../shared/domain/lead.js"

type GoogleSheetsLeadRepositoryOptions = {
  sheetId: string
  range: string
...
export class GoogleSheetsLeadRepository implements LeadRepository {
  ...
  constructor(private readonly options: GoogleSheetsLeadRepositoryOptions) {
  ...
  async appendLead(lead: Lead): Promise<PersistedLead> {
