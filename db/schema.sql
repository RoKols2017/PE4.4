...
CREATE INDEX IF NOT EXISTS idx_leads_source_created_at ON leads (source, created_at_utc DESC);
CREATE INDEX IF NOT EXISTS idx_leads_status_created_at ON leads (status, created_at_utc DESC);
...
CREATE INDEX IF NOT EXISTS idx_lead_events_lead_id_created_at ON lead_events (lead_id, created_at_utc DESC);
