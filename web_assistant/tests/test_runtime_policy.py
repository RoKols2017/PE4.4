...
def test_parse_structured_response_rejects_unexpected_keys() -> None:
    payload = (
        '{"detected_intent":"answer_current_step","candidate_fields":{"name":null,"contact":null,'
        '"request":null},"needs_clarification":false,"user_facing_message":"Принял.","extra":1}'
    )
